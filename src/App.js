...
const BankCardAnalyzer = () => {
  ...
  const analyzeCardNumbers = useCallback(() => {
    ...
    if (invalidNumbers.length > 0) {
      setValidationError(`💳❌Invalid Card Numbers: Please double-check and enter valid card details. ✅: ${invalidNumbers.join(', ')}`);
      setShowErrorDialog(true);
      return;
    }
        ...
        >
          ...
          <CardContent className="space-y-4 p-6">
            ...
            {isAnalyzing && (
              ...
              >
                🔍💳 Analyzing Card Numbers... Please wait while we verify your input. ⏳
              </motion.div>
            )}
